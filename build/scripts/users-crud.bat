...
set CLASSPATH=%APP_HOME%\lib\users-crud-1.0.0-SNAPSHOT.jar;%APP_HOME%\lib\vertx-web-3.8.1.jar;%APP_HOME%\lib\vertx-lang-kotlin-3.8.1.jar;%APP_HOME%\lib\vertx-web-common-3.8.1.jar;%APP_HOME%\lib\vertx-auth-common-3.8.1.jar;%APP_HOME%\lib\vertx-bridge-common-3.8.1.jar;%APP_HOME%\lib\vertx-core-3.8.1.jar;%APP_HOME%\lib\kotlin-stdlib-jdk8-1.3.30.jar;%APP_HOME%\lib\netty-handler-proxy-4.1.39.Final.jar;%APP_HOME%\lib\netty-codec-http2-4.1.39.Final.jar;%APP_HOME%\lib\netty-codec-http-4.1.39.Final.jar;%APP_HOME%\lib\netty-handler-4.1.39.Final.jar;%APP_HOME%\lib\netty-resolver-dns-4.1.39.Final.jar;%APP_HOME%\lib\netty-codec-socks-4.1.39.Final.jar;%APP_HOME%\lib\netty-codec-dns-4.1.39.Final.jar;%APP_HOME%\lib\netty-codec-4.1.39.Final.jar;%APP_HOME%\lib\netty-transport-4.1.39.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.39.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.39.Final.jar;%APP_HOME%\lib\netty-common-4.1.39.Final.jar;%APP_HOME%\lib\jackson-databind-2.9.9.1.jar;%APP_HOME%\lib\jackson-core-2.9.9.jar;%APP_HOME%\lib\kotlin-stdlib-jdk7-1.3.30.jar;%APP_HOME%\lib\kotlin-stdlib-1.3.30.jar;%APP_HOME%\lib\jackson-annotations-2.9.0.jar;%APP_HOME%\lib\kotlin-stdlib-common-1.3.30.jar;%APP_HOME%\lib\annotations-13.0.jar
